define([], function () {
    ...
    angular.module('app.yangman').controller('HistorySettingsCtrl', CollectionsSettingsCtrl);

    CollectionsSettingsCtrl.$inject = ['$mdDialog', 'settingsObj'];

    function CollectionsSettingsCtrl($mdDialog, settingsObj) {
    ...
    return CollectionsSettingsCtrl;
